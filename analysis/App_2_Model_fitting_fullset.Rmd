...
best_idx <- 18
dat_jags$mod_cvrs <- scl_cvrs[,c("flow_wtr","flow_sum","Hrel")]
## params/states to return
par_jags <- c("alpha","E_BH_a","ln_BH_a",
              ...
              "pi_eta","pi_tau",
              "sigma_r","sigma_s","res_ln_Rec")
best_fit <- fit_jags("IPM_BH_cov2_AR.txt", dat_jags, par_jags, init_vals_cov2, mcmc_ctrl)
```

...
`r fig_cap(1, caption = "Time series of the estimated total population size (catch plus the adults that escaped to spawn). The observed data are the points; the solid line is the median estimate and the shaded region represents the 95% credible interval.", display = "full")`
...
`r fig_cap(3, caption = "Time series of the environmental covariates used in the model (a-d), and their estimated effects on population productivity (e-g). Small arrows under histograms denote 2.5th percentile, 50th percentile, and 97.5th percentile of the posterior distribution.", display = "full")`

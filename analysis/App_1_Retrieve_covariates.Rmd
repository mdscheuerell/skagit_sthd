---
title: Appendix S1. Detailed instructions for retrieving and archiving the environmental covariates.
...
All analyses require the [R software](https://cran.r-project.org/) (v3.4.3) for data retrieval and processing. We also need the __readr__ and __here__ packages, which are not included with the base installation of R.

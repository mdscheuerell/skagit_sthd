...
This appendix describes how we fit the various model forms and evaluated their relative performances. We load the fish data and the environmenal covariates, specify the different models in the the __JAGS__ software, and then fit each of them. 

...
## Difference will be positive (negative) if the expected predictive accuracy for the second (first) model is higher.
## Ricker with(out) covariates
compare(LOO_both[[1]], LOO_both[[3]])
## BH with(out) covariates

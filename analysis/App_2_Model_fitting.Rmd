...
for(i in 1:4) {
  cc_smry[i,2:4] <- round(summary(mod_fits[[3]])$quantiles[paste0("gamma[",i,"]"),
                                                           c("2.5%","50%","97.5%")], 3)
  cc_smry[i,5:7] <- round(summary(mod_fits[[4]])$quantiles[paste0("gamma[",i,"]"),
                                                           c("2.5%","50%","97.5%")], 3)
}
cc_smry
```
...
par(mfrow=c(1,2), mai=c(1,1,0.2,0.1), omi=rep(0.1,4))

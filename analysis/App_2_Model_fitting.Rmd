...
```{r fit_Ricker_base, message = FALSE, warning = FALSE, cache = FALSE}
...
if(file.exists(file.path(savedir, "fit_ricker_base.rds"))) {
  mod_fits[[1]] <- readRDS(file.path(savedir, "fit_ricker_base.rds"))
} else { ## else, fit & save
  mod_fits[[1]] <- fit_jags("IPM_RK_AR.txt", dat_jags, par_jags, init_vals_AR, mcmc_ctrl)
  saveRDS(mod_fits[[1]], file.path(savedir, "fit_ricker_base.rds"))
}
```
...
```{r fit_BH_base, message = FALSE, warning = FALSE, cache = FALSE}
## params/states to return
...
if(file.exists(file.path(savedir, "fit_bh_base.rds"))) {
  mod_fits[[2]] <- readRDS(file.path(savedir, "fit_bh_base.rds"))
} else { ## else, fit & save
  mod_fits[[2]] <- fit_jags("IPM_BH_AR.txt", dat_jags, par_jags, init_vals_AR, mcmc_ctrl)
  saveRDS(mod_fits[[2]], file.path(savedir, "fit_bh_base.rds"))
}
```
...
```{r fit_Ricker_cov, message = FALSE, warning = FALSE, cache = FALSE, eval=TRUE}
## params/states to return
par_jags <- c("alpha","E_Rkr_a","mu_Rkr_a",
              "beta",
              "gamma",
...
if(file.exists(file.path(savedir, "fit_ricker_cov.rds"))) {
  mod_fits[[3]] <- readRDS(file.path(savedir, "fit_ricker_cov.rds"))
} else { ## else, fit & save
  mod_fits[[3]] <- fit_jags("IPM_RK_cov_AR.txt", dat_jags, par_jags,
                            init_vals_cov, mcmc_ctrl)
  saveRDS(mod_fits[[3]], file.path(savedir, "fit_ricker_cov.rds"))
}
```

### Beverton-Holt

```{r fit_BH_cov, message = FALSE, warning = FALSE, cache = FALSE, eval=TRUE}
## params/states to return
...
if(file.exists(file.path(savedir, "fit_bh_cov.rds"))) {
  mod_fits[[4]] <- readRDS(file.path(savedir, "fit_bh_cov.rds"))
} else { ## else, fit & save
  mod_fits[[4]] <- fit_jags("IPM_BH_cov_AR.txt", dat_jags, par_jags,
                            init_vals_cov, mcmc_ctrl)
  saveRDS(mod_fits[[4]], file.path(savedir, "fit_bh_cov.rds"))
}
```

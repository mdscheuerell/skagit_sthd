...
jm <- jags.model("IPM_RK_cov_AR.txt", n.chains=4, data=dat_jags, n.adapt=20000, inits = init_vals_cov_AR)
ss <- coda.samples(jm, par_jags, n.iter=20000, thin=20)

lapply(ss[,"Sp[1]"], mean)

lapply(ss[,"Sp[5]"], mean)

lapply(ss[,"Sp[10]"], mean)

...
init_vals_AR <- function() {
	list(alpha = 2,
	     ...
	     pi_tau = 1,
	     pi_eta = rep(1,A),
	     pi_vec = matrix(c(0.02,0.3,0.47,0.15,0.04,0.02), n_yrs-age_min+n_fore, A,
	                     byrow = TRUE),
	     Rec_mu = log(1000),
	     Rec_sig = 0.1,
...
init_vals_cov_AR <- function() {
	list(alpha = 3,
	     ...
	     pi_tau = 1,
	     pi_eta = rep(1,A),
	     pi_vec = matrix(c(0.02,0.3,0.48,0.15,0.04,0.01), n_yrs-age_min+n_fore, A,
	                     byrow = TRUE),
	     Rec_mu = log(1000),
	     Rec_sig = 0.1,
	     tot_ln_Rec = rep(log(1000),n_yrs-age_min+n_fore),

...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gamma_CI <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(c_est, }\DecValTok{2}\NormalTok{, quantile, CI_vec)}
...
\begin{verbatim}
##           2.5%   50% 97.5%
## gamma[1] -0.26 -0.11  0.06
## gamma[2] -0.07  0.08  0.25
## gamma[3] -0.08  0.09  0.27
## gamma[4] -0.36 -0.20 -0.03
\end{verbatim}
